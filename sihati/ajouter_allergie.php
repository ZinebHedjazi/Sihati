<?php 
    ...
    if(isset($_POST['medicament']) && isset($_POST['alimentation']) && isset($_POST['id_user'])){
        ...
        $insert = $bdd->prepare('INSERT INTO allergie(medicament, alimentation, id_user) VALUES(:medicament, :alimentation, :id_user)');
        ...
        header('Location:ajouter_antecedant.php?reg_erra=success');
                            die();
