                    ...
                    <div class="col-md-8 col-sm-6" id="antécedents">
                         <!-- CONTACT FORM HERE -->
                              ...
                              ?>
                                   ...
                                   <form id="diagnostic_form" role="form" method="post" action="ajouter_diagnostic.php">
                                        <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                             <h5>Diagnostic :</h5>
                                        </div>
                                        <div class="col-md-12 col-sm-12" id="allergie">
                                            ...
                                            <div class="col-md-10 col-sm-6">
                                             ...
                                             <button type="submit" value="<?php echo  $id_ajout ; ?>" name="id_user" class="btn btn-primary">Ajouter</button>
                              ...
                              ?>
                                    <form id="diagnostic_form" role="form" method="post" action="ajouter_allergie.php">
                                        <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                            <h5>Allergie :</h5>
                                        </div>
                                        <div class="col-md-12 col-sm-12" id="allergie">
                              ...
                              ?>
                                    <form id="diagnostic_form" role="form" method="post" action="ajouter_autre.php">
                                        <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                            <h5>Autre :</h5>
                                        </div>
                                        <div class="col-md-12 col-sm-12" id="allergie">
                              ...
                              ?>
                                   <form id="diagnostic_form" role="form" method="post" action="ajouter_chirurgie.php">
                                        <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="col-md-4 col-sm-6">
                                             ...
                                             <a href="modification_dossier.php"><button type="button" class="btn btn-primary btn-lg btn-block" id="compte">Retour</button></a>
