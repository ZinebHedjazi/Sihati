<?php 
    ...
    if(isset($_POST['maladie']) && isset($_POST['type']) && isset($_POST['traitement']) && isset($_POST['date_apparition']) && isset($_POST['id_user'])){
        ...
        $insert = $bdd->prepare('INSERT INTO diagnostic_m(maladie, type, traitement, date_apparition, id_user) VALUES(:maladie, :type, :traitement, :date_apparition, :id_user)');
        ...
        header('Location:validation_m1.php?reg_errm=success');
                            die();
