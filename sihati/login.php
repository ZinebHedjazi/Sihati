     ...
     <section id="appointment" data-stellar-background-ratio="3">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6" id="formulaire">
                         <!-- CONTACT FORM HERE -->
                         ...
                         <form enctype="multipart/form-data" action="connexion.php" method="post">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-12 col-sm-12">
                                        <label for="telephone">N° téléphone ou mail </label>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg btn-block" id="compte">Se connecter</button>
                                    
                                        .
                                        <p>      Vous n'avez pas de compte ?<a href="inscription1.php" id="inscription"> Inscrivez-vous. </a> </p>
                                   </div>   
                         </form>
                    </div> 
               </div>
