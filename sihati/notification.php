...
<head>
     ...
     <title>Sihati - notification</title>
<!--
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li class="appointment-btn"><a href="login.php">Connexion</a></li>
          ...
          <div class="container" >
               ...
               <div class="row" >
                    ...
                    <div class="col-md-8 col-sm-8" >
                         <div class="alert alert-success" id="succés">
                              <strong>Succès</strong> inscription réussie ! votre compte a été bien créé, <a href="login.php" id="inscription"> connectez-vous </a> pour le compléter . Veuillez venir le plutôt possible <?php if($diagnostic=="diabete"){echo " à la maison diabète " ;}else{ if($diagnostic=="HTA"){echo " au service cardiologie ";}}  ?> au niveau d'EPH Dr Hakim Saadan pour la validation de votre dossier par l'administation.
                         </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.4s">
                              ...
                              <div class="news-info">
                                   ...
                                   <h3><a href="news-detail.html" id="notif">À propos de nous</a></h3>
                                   <p>nous veillerons à ce que vous soyez en bonne santé.</p>
