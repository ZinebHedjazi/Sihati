...
<div class="row">
  <div class="profile-nav col-md-3">
      <div class="panel">
        ...
        <form action="validation_a.php" method="GET">
                
            <ul class="nav nav-pills nav-stacked">
               <li class="active"><a href="#"> <i class="fa fa-user"></i> Profile</a></li>
               <li><button type="submit"  name="id" id="im" class="btn btn-primary btn-lg btn-block"><i class="fa fa-check"></i> Ajouter </button></li>
