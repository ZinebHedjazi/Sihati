<?php 
    ...
    if(isset($_POST['medicament']) && isset($_POST['alimentation']) && isset($_POST['id_user'])){
        ...
        $insert = $bdd->prepare('INSERT INTO allergie_m(medicament, alimentation, id_user) VALUES(:medicament, :alimentation, :id_user)');
        ...
        header('Location:validation_m1.php?reg_erra=success');
                            die();
