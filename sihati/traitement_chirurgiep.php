<?php 
    ...
    if(isset($_POST['type']) && isset($_POST['suites']) && isset($_POST['sequelles']) && isset($_POST['id_user'])){
        ...
        $insert = $bdd->prepare('INSERT INTO chirurgie_p(type, suites, sequelles, id_user) VALUES(:type, :suites, :sequelles, :id_user)');
        ...
        header('Location:validation_p.php?reg_errc=success');
                            die();
