               ...
               <div class="row" >
                    ...
                    <div class="col-md-6 col-sm-6" >
                         <div class="alert alert-success" id="succés">
                              <strong>Succès</strong> Validation ! le dossier médical a été validé .
                         </div>
                    </div>
                    <div class="col-md-2 col-sm-2" >
                    <a href="admin.php"><button type="button" class="btn btn-primary btn-lg btn-block" id="compte">Retour</button></a>
