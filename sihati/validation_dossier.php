    ...
    <div class="col-md-10 col-sm-8">
		...
		<div class="list-group">     
            ...
            <div class="list-group-item clearfix">
                ...
                <form action="profil_validation.php" method="GET"> 
                <div class="profile-teaser-main">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="info"><span class="">Téléphone : </span> <?= $m['phone'] ?></div>
                     
                        <button type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light" value="<?= $m['id'] ?>" id="accepter" name="id">Afficher</button>
                        
                    
                        <button type="submit" class="btn btn-primary mt-3 btn-rounded waves-effect w-md waves-light" value="<?= $m['id'] ?>"id="supprimer">Refuser</button>
