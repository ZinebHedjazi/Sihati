...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50" id="body">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                    <div class="col-md-12 col-sm-12"> 
                                        ...
                                        <div class="col-md-12 col-sm-12" id="allergie">
                                            ...
                                            <input type="text" class="form-control" id="médicaments" name="médicaments" placeholder="">
                                ...
                                veuillez valider l'inscription   
                                             ...
                                             <button type="button" class="btn btn-primary btn-lg btn-block" id="compte">Valider</button>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="validation_2.php">2</a></li>
