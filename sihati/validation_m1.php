                    ...
                    <div class="col-md-8 col-sm-6" id="antécedents">
                         <!-- CONTACT FORM HERE -->
                              ...
                              <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                   <h2>Antécédents familials (Mère) :</h2>
                              </div>
                              <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                    ...
                                    <?php
                              if(isset($_GET['reg_errm']))
                              {
                                   $errm = htmlspecialchars($_GET['reg_errm']);
                              ...
                              ?>
                                   <form id="diagnostic_form" role="form" method="post" action="diagnosticm_traitement.php">
                              ...
                              ?>
                                    <form id="diagnostic_form" role="form" method="post" action="traitement_allergiem.php">
...
?>
    <form id="diagnostic_form" role="form" method="post" action="traitement_autrem.php">
        <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
            <h5>Autre :</h5>
        </div>
        <div class="col-md-12 col-sm-12" id="allergie">
...
<h5> . </h5>
                              ...
                              ?>
                                   <form id="diagnostic_form" role="form" method="post" action="traitement_chirurgiem.php">
                                ...
                                veuillez valider l'inscription   
                                             ...
                                             <a href="validation.php"><button type="button" class="btn btn-primary btn-lg btn-block" id="compte">Valider</button></a>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="validation_a.php">1</a></li>
