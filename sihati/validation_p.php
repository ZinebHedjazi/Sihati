                    ...
                    <div class="col-md-8 col-sm-6" id="antécedents">
                         <!-- CONTACT FORM HERE -->
                              ...
                              <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                                   <h2>Antécédents familials (Père) :</h2>
                              </div>
                              <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
                              ...
                              ?>
                                   <form id="diagnostic_form" role="form" method="post" action="diagnosticp_traitement.php">
                              ...
                              ?>
                                    <form id="diagnostic_form" role="form" method="post" action="traitement_allergiep.php">
...
?>
    <form id="diagnostic_form" role="form" method="post" action="traitement_autrep.php">
        <div class="section-title wow fadeInUp" data-wow-delay="0.4s">
            <h5>Autre :</h5>
        </div>
        <div class="col-md-12 col-sm-12" id="allergie">
...
<h5> . </h5>
                              ...
                              ?>
                                   <form id="diagnostic_form" role="form" method="post" action="traitement_chirurgiep.php">
  ...
  <ul class="pagination">
    ...
    <li class="page-item">
      <a class="page-link" href="validation_m1.php">Suivant</a>
    </li>
  </ul>
</nav>
</div>
